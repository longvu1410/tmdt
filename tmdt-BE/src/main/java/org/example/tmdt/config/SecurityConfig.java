...
import org.example.tmdt.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .exceptionHandling(exception -> exception
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            String message = jwtError == null ? "Unauthorized" : jwtError.toString();
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/users/*/follow-stats").permitAll()
                        ...
                        .requestMatchers("/swagger-resources/**", "/webjars/**", "/favicon.ico").permitAll()
